...
class PaymentEntry(models.Model):
    ...
    cash_amount = models.FloatField('Amount Paid by Cash')
    cheque_amount = models.FloatField('Amount Paid by Cheque')
    eftpos_amount = models.FloatField('Amount Paid by EFTPOS')
